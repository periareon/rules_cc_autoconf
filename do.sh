...
bazel test -k -- //gnulib/tests/compatibility/c-stack:c-stack_test_gnu_autoconf \
//gnulib/tests/compatibility/func:func_test_gnu_autoconf \
//gnulib/tests/compatibility/gc:gc_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-arcfour:gc-arcfour_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-arctwo:gc-arctwo_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-camellia:gc-camellia_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-des:gc-des_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-hmac-md5:gc-hmac-md5_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-hmac-sha1:gc-hmac-sha1_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-hmac-sha256:gc-hmac-sha256_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-hmac-sha512:gc-hmac-sha512_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-md4:gc-md4_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-md5:gc-md5_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-rijndael:gc-rijndael_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-sha1:gc-sha1_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-sha256:gc-sha256_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-sha512:gc-sha512_test_gnu_autoconf \
//gnulib/tests/compatibility/gc-sm3:gc-sm3_test_gnu_autoconf \
//gnulib/tests/compatibility/gettext:gettext_test_gnu_autoconf \
//gnulib/tests/compatibility/host-cpu-c-abi:host-cpu-c-abi_test_gnu_autoconf \
//gnulib/tests/compatibility/iconv_open:iconv_open_test_gnu_autoconf \
//gnulib/tests/compatibility/init-package-version:init-package-version_test_gnu_autoconf \
//gnulib/tests/compatibility/javacomp:javacomp_test_gnu_autoconf \
//gnulib/tests/compatibility/largefile:largefile_test_gnu_autoconf \
//gnulib/tests/compatibility/lib-link:lib-link_test_gnu_autoconf \
//gnulib/tests/compatibility/libsigsegv:libsigsegv_test_gnu_autoconf \
//gnulib/tests/compatibility/libtextstyle:libtextstyle_test_gnu_autoconf \
//gnulib/tests/compatibility/libtextstyle-optional:libtextstyle-optional_test_gnu_autoconf \
//gnulib/tests/compatibility/libunistring:libunistring_test_gnu_autoconf \
//gnulib/tests/compatibility/libunistring-base:libunistring-base_test_gnu_autoconf \
//gnulib/tests/compatibility/libunistring-optional:libunistring-optional_test_gnu_autoconf \
//gnulib/tests/compatibility/manywarnings:manywarnings_test_gnu_autoconf \
//gnulib/tests/compatibility/minus-zero:minus-zero_test_gnu_autoconf \
//gnulib/tests/compatibility/nocrash:nocrash_test_gnu_autoconf \
//gnulib/tests/compatibility/progtest:progtest_test_gnu_autoconf \
//gnulib/tests/compatibility/sigsegv:sigsegv_test_gnu_autoconf \
//gnulib/tests/compatibility/std-gnu23:std-gnu23_test_gnu_autoconf \
//gnulib/tests/compatibility/stdint:stdint_test_gnu_autoconf_macos \
//gnulib/tests/compatibility/terminfo:terminfo_test_gnu_autoconf
