...
#include "autoconf/tests/requires/config.h"
...
// STRING_H_IF_FALSE should NOT be defined (if_false doesn't run when string.h
// exists)
#ifdef STRING_H_IF_FALSE
#error "STRING_H_IF_FALSE should NOT be defined (if_false when string.h exists)"
#endif

// NONEXISTENT2_IF_TRUE should NOT be defined (if_true doesn't run when header
// missing)
#ifdef NONEXISTENT2_IF_TRUE
#error \
    "NONEXISTENT2_IF_TRUE should NOT be defined (if_true when header missing)"
#endif
