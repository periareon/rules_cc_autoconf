...
def gnu_autoconf_diff_test(
    ...
    py_test(
        name = name,
        srcs = [Label("//autoconf/tests:gnu_autoconf_diff_tester.py")],
        main = Label("//autoconf/tests:gnu_autoconf_diff_tester.py"),
        data = data,
        env = env,
        deps = [Label("//autoconf/tests:gnu_autoconf_diff_tester")],
        **kwargs
    )
