...
*run* a compiled test binary will not behave well when the Bazel execution
...
- `AC_CHECK_HEADER`, `AC_CHECK_FUNC`, `AC_CHECK_TYPE`, `AC_CHECK_SYMBOL`
...
def _ac_check_header(header, define = None, language = "c"):
...
def _ac_check_func(function, define = None, code = None, file = None, language = "c"):
...
def _ac_check_type(type_name, *, define = None, code = None, file = None, language = "c"):
    """Check for a type.
...
def _ac_check_symbol(symbol, *, define = None, code = None, file = None, language = "c"):
...
def _ac_try_compile(*, code = None, file = None, define = None, language = "c"):
...
def _ac_check_sizeof(type_name, *, define = None, headers = None, language = "c"):
...
def _ac_check_alignof(type_name, *, define = None, headers = None, language = "c"):
...
def _ac_check_decl(symbol, *, define = None, headers = None, language = "c"):
...
def _ac_check_member(aggregate, member, *, define = None, headers = None, language = "c"):
...
def _ac_compute_int(define, expression, *, headers = None, language = "c"):
...
def _ac_c_bigendian(define = "WORDS_BIGENDIAN", language = "c"):
...
def _ac_c_inline(define = "inline", language = "c"):
...
def _ac_c_restrict(define = "restrict", language = "c"):
...
def _ac_prog_cc_c_o(define = "NO_MINUS_C_MINUS_O", language = "c"):
...
def _ac_check_c_compiler_flag(flag, define = None, language = "c"):
...
def _ac_check_cxx_compiler_flag(flag, define = None, language = "cpp"):
    """Check if the C++ compiler supports a specific flag.
