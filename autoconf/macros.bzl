...
def _ac_check_header(header, define = None, language = "c", requires = None):
...
def _ac_check_func(function, define = None, code = None, file = None, language = "c", requires = None):
...
def _ac_check_type(type_name, *, define = None, code = None, file = None, language = "c", requires = None):
    """Check for a type.
...
def _ac_check_symbol(symbol, *, define = None, code = None, file = None, language = "c", requires = None):
    ...
    Example:
    ```python
    macros.AC_CHECK_SYMBOL("NULL", define = "HAVE_NULL", code = "#include <stddef.h>")
...
def _ac_try_compile(*, code = None, file = None, define = None, language = "c", requires = None):
...
def _ac_check_sizeof(type_name, *, define = None, headers = None, language = "c", requires = None):
...
def _ac_check_alignof(type_name, *, define = None, headers = None, language = "c", requires = None):
...
def _ac_check_decl(symbol, *, define = None, headers = None, language = "c", requires = None):
...
def _ac_check_member(aggregate, member, *, define = None, headers = None, language = "c", requires = None):
...
def _ac_compute_int(define, expression, *, headers = None, language = "c", requires = None):
...
def _ac_c_bigendian(define = "WORDS_BIGENDIAN", language = "c", requires = None):
...
def _ac_c_inline(define = "inline", language = "c", requires = None):
...
def _ac_c_restrict(define = "restrict", language = "c", requires = None):
...
def _ac_prog_cc_c_o(define = "NO_MINUS_C_MINUS_O", language = "c", requires = None):
...
def _ac_check_c_compiler_flag(flag, define = None, language = "c", requires = None):
...
def _ac_check_cxx_compiler_flag(flag, define = None, language = "cpp", requires = None):
    """Check if the C++ compiler supports a specific flag.
...
def _ac_check_lib(library, function, *, define = None, code = None, file = None, language = "c", requires = None):
...
def _ac_define(define, value = "1", requires = None):
...
def _m4_define(define, value = "1", requires = None):
