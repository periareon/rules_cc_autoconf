...
struct ResolverArgs {
    ...
    /** Path to JSON package info file */
    std::filesystem::path package_info_path{};

    /** Optional path to template file (config.h.in) */
    std::optional<std::filesystem::path> template_path{};

    /** Optional path to config file (for running additional checks) */
    std::optional<std::filesystem::path> config_path{};

    /** Path to output config.h file */
    std::filesystem::path output_path{};

    /** Optional path to output merged results JSON file */
    std::optional<std::filesystem::path> output_results_path{};
