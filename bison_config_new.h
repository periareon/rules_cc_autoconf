...
#define GNULIB_REALLOCARRAY 0

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module scanf shall be considered present. */
#define GNULIB_SCANF 0
...
#define PACKAGE_STRING "GNU Bison 3.8.2.bcr.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "GNU Bison"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://www.gnu.org/software/bison/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "3.8.2.bcr.1"
