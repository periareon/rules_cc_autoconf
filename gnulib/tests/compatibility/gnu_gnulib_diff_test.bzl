...
def gnu_gnulib_diff_test(
    ...
    py_test(
        name = name,
        srcs = [Label("//gnulib/tests/compatibility:gnu_gnulib_diff_tester.py")],
        main = Label("//gnulib/tests/compatibility:gnu_gnulib_diff_tester.py"),
        data = data,
        env = env,
        deps = [Label("//gnulib/tests/compatibility:gnu_gnulib_diff_tester")],
        size = size,
